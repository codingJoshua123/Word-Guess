...
BACKGROUND_RECT = BACKGROUND.get_rect(center=(210, 190))
ICON = pygame.image.load("assets/Icon.png")

pygame.display.set_caption("Python Word Game (CS2C)")
...
def play_again():
    ...
    word_was_rect = word_was_text.get_rect(center=(WIDTH/2, 550))
